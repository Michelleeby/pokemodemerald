...
#define FLAG_SYS_PC_FROM_POKENAV    0x20
...
#define FLAG_SYS_DEXNAV_FROM_POKENAV                (SYSTEM_FLAGS + 0x23)
...
#define FLAG_SYS_DEXNAV_GET                         (SYSTEM_FLAGS + 0x2F) // dexnav shows in pokenav
