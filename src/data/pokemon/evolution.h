const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MACHOKE]    = {{EVO_ITEM, ITEM_BLACK_BELT, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]   = {{EVO_TRADE_ITEM, ITEM_HARD_STONE, SPECIES_GOLEM}},
    ...
    [SPECIES_HAUNTER]    = {{EVO_ITEM, ITEM_SPELL_TAG, SPECIES_GENGAR}},
