...
const u8 gText_Pokenav_Open_Dexnav[] = _("Open the DEXNAV.");
const u8 gText_Pokenav_Acces_PC[] = _("Access your PC.");
const u8 gText_PutAwayPokenav[] = _("Put away the POKéNAV.");
const u8 gText_Pokenav_Cannot_Open_Dexnav[] = _("Can't open DEXNAV here.");
const u8 gText_Pokenav_Cannot_Acces_PC[] = _("Can't access PC. Go outside.");
